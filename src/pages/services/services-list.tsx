...
import ServiceView from 'sections/ServiceView';

import { useDispatch, useSelector } from 'store';
import { getServices } from 'store/reducers/service';
...
const ServiceList = () => {
  ...
  const renderRowSubComponent = useCallback(({ row }: { row: Row }) => <ServiceView data={products[Number(row.id)]} />, [products]);
